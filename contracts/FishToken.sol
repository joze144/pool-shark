...
contract FishToken is iFishToken, Ownable, Timed {
    ...
    function transfer(address _to, uint256 _value) external onlyWhileOpen returns (bool success) {
    ...
    function issue(address _beneficiary, uint256 _amount) external onlyOwner onlyWhileOpen returns (bool success) {
